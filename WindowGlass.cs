...
class Config {
    ...
    public double SizeExternal = 1.5;      // extra multiplier on an external monitor (a display wider than 35 cm); the laptop panel gets Size alone
...
"SizeExternal=1.5     # extra multiplier on an external monitor (any display wider than 35 cm)\r\n" +
